<template>
    <p>
        <a-space>
            ...
            <StationSelectComponents v-model="params.start" width="200px"></StationSelectComponents>
            <StationSelectComponents v-model="params.end" width="200px"></StationSelectComponents>
...
import StationSelectComponents from "@/components/Station-select.vue";
import dayjs from "dayjs";

export default defineComponent({
    name: "daily-train-ticket-view",
    components: {StationSelectComponents, TrainSelectComponents},
    setup() {
