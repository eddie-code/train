<template>
  <p>
    <a-space>
        ...
        <train-select-components v-model="params.code" width="200px"></train-select-components>
  ...
  <a-modal v-model:visible="visible" title="每日车次" @ok="handleOk"
    ...
    <a-form :model="dailyTrain" :label-col="{span: 4}" :wrapper-col="{ span: 20 }">
      ...
      <a-form-item label="车次编号">
          <TrainSelectComponents v-model="dailyTrain.code" @change="onChangeCode"></TrainSelectComponents>
      </a-form-item>
